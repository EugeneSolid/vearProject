...
<template>
  <div class="settings-page w-100">
    <div class="main-info-section">
      <p class="mb-3 settings-page__title">Account Settings</p>
      <div class="settings-page__section">
        ...
        <p class="settings-page__info-text">You can only update your name via ID Verification. To get started, please contact us via chat in the lower
        ...
        <p class="settings-page__info-text">This will be hou your name will be displayed in the account section and in reviews.</p>
        <div style="margin-top: 28px;" class="d-flex flex-column w-100">
          <label class="section-label">Email Address <span class="error">*</span></label>
          <p class="mb-3 section-field disabled">vn@vear.me</p>
        </div>
        <p class="settings-page__info-text mb-0">If you want to change your email, please contact us via chat in the lower right corner of the screen.</p>
      </div>
    </div>
    <div>
      <p class="mb-3 settings-page__title">Password Change</p>
      <div class="settings-page__section">
        <div class="d-flex flex-column w-100">
    ...
    <div class="d-flex justify-content-between resident-question align-items-center">
      <p class="settings-page__info-text mb-0">Are you a resident or cetizen of the united states or It’s Territories? <span class="error">*</span></p>
