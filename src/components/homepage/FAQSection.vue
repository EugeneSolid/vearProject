  ...
  <div class="faq-section" id="faqSection">
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                ...
                <i class="accordion-icon fi fi-sr-dollar"></i><span class="faq-question ms-3">How will rent be paid?</span>
              </button>
            </h2>
         ...
         <div class="accordion-item">
           <h2 class="accordion-header">
             <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
               ...
               <i class="accordion-icon fi fi-rs-home"></i><span class="faq-question ms-3">Who owns the properties?</span>
             </button>
           </h2>
    ...
    <div class="w-100 d-flex justify-content-center">
      <router-link to="/login" class=" mt-3 show-all-properties-btn">
        See All F.A.Q <i class="accordion-icon fi fi-sr-angle-small-right"></i>
      </router-link>
    </div>
  </div>
</template>
